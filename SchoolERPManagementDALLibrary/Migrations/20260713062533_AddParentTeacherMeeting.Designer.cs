...
namespace SchoolERPManagementDALLibrary.Migrations
{
    ...
    [Migration("20260713062533_AddParentTeacherMeeting")]
    partial class AddParentTeacherMeeting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolERPManagementModelLibrary.Models.Classsubject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SchoolERPManagementModelLibrary.Models.Parentteachermeeting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("Academiccalendarid")
                        .HasColumnType("integer")
                        .HasColumnName("academiccalendarid");
                    ...
                    b.HasKey("Id")
                        .HasName("parentteachermeetings_pkey");

                    b.HasIndex("Academiccalendarid");

                    b.HasIndex("Academicyearid");

                    b.ToTable("parentteachermeetings", (string)null);
                });

            modelBuilder.Entity("SchoolERPManagementModelLibrary.Models.Parentteacherslot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("parentteacherslots_pkey");
                    ...
                    b.HasIndex(new[] { "Meetingid", "Teacherid", "Starttime" }, "parentteacherslots_meetingid_teacherid_starttime_key")
                        .IsUnique();

                    b.ToTable("parentteacherslots", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolERPManagementModelLibrary.Models.Parentteachermeeting", b =>
                {
                    b.HasOne("SchoolERPManagementModelLibrary.Models.Academiccalendar", "Academiccalendar")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolERPManagementModelLibrary.Models.Parentteacherslot", b =>
                {
                    b.HasOne("SchoolERPManagementModelLibrary.Models.Parentteachermeeting", "Meeting")
                        .WithMany("Parentteacherslots")
            ...
            modelBuilder.Entity("SchoolERPManagementModelLibrary.Models.Parentteachermeeting", b =>
                {
                    b.Navigation("Parentteacherslots");
                });
